...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1QZoEhTE9mHYLOyMxnRLe8Ry_IhrhShox/view?usp=sharing",
  ...
  // },
{
  ...
  image: carrent,
  github: "https://github.com/chakri6303/Blood_Bank",
},    
{
  title: "Public News",
  description: "Designed and developed a user-friendly news app with XML and Material Design for smooth navigation and reading. Ensured performance optimization for real-time updates and efficient content delivery.",
  tags: [
    {
      name: "android Studio",
      color: "blue-text-gradient",
...
{
  title: "Mentor Mate",
  description: "Developed an Mentor Mate app to streamline communication within educational institutions. This solution improves classroom interactions, enhances engagement, and simplifies management for all users.",
  tags: [
    {
      name: "android studio",
      color: "blue-text-gradient",
